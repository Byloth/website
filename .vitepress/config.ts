...
export default defineConfig({
    ...
    head: [
        ...
        ["link", {
            ...
            href: "/favicons/bylothink-167x167.png",
            sizes: "167x167",
            type: "image.png"
        }],
        ...
        ["link", {
            rel: "apple-touch-icon",
            href: "/favicons/bylothink-180x180.png",
            sizes: "180x180",
            type: "image.png"
        }],
    ...
    themeConfig: {
        ...
        socialLinks: [
            ...
            { icon: "mastodon", link: "https://mastodon.uno/@byloth" },
...
<a href="https://github.com/Byloth">
  Matteo Bilotta</a>. Alcuni diritti riservati.`
        }
    },
    vite: {
        resolve: {
